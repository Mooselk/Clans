...
public class MainConfig {
    ...
    public class Commands {
        ...
        public class Fly {
            ...
            @Comment("Trails show below the players foot when flying, faction.fly.trails\n" +
                    "Players can enable them with /c trail on/off\n" +
                    "Players can also set which effect to show /c trail effect <particle> only if they have faction.fly.trails.<particle>")
        ...
        public class Help {
            @Comment("You can change the page name to whatever you like\n" +
                    "We use '1' to preserve default functionality of /c help 1")
            private Map<String, List<String>> entries = new HashMap<String, List<String>>() {
                {
                    this.put("1", Arrays.asList(
                            ...
                            "                  &c&lFactions Help               ",
                            "&e&m----------------------------------------------",
                            "&3/c create  &e>>  &7Create your own faction",
                            "&3/c who      &e>>  &7Show factions info",
                            "&3/c tag      &e>>  &7Change faction tag",
                            "&3/c join     &e>>  &7Join faction",
                            "&3/c list      &e>>  &7List all factions",
                            "&e&m--------------&r &2/c help 2 for more &e&m--------------"));
                    this.put("2", Arrays.asList(
                            "&e&m------------------&r&c&l Page 2 &e&m--------------------",
                            "&3/c home     &e>>  &7Teleport to faction home",
                            "&3/c sethome &e>>  &7Set your faction home",
                            "&3/c leave    &e>>  &7Leave your faction",
                            "&3/c invite    &e>>  &7Invite a player to your faction",
                            "&3/c deinvite &e>>  &7Revoke invitation to player",
                            "&e&m--------------&r &2/c help 3 for more &e&m--------------"));
                    this.put("3", Arrays.asList(
                            "&e&m------------------&r&c&l Page 3 &e&m--------------------",
                            "&3/c claim     &e>>  &7Claim land",
                            "&3/c unclaim  &e>>  &7Unclaim land",
                            "&3/c kick      &e>>  &7Kick player from your faction",
                            "&3/c mod      &e>>  &7Set player role in faction",
                            "&3/c chat     &e>>  &7Switch to faction chat",
                            "&e&m--------------&r &2/c help 4 for more &e&m--------------"));
                    this.put("4", Arrays.asList(
                            "&e&m------------------&r&c&l Page 4 &e&m--------------------",
                            "&3/c version &e>>  &7Display version information",
                            "&e&m--------------&r&2 End of /c help &e&m-----------------"));
                }
            };
        ...
        public class SeeChunk {
            ...
            @Comment("Get a list of particle names here: https://cactions.support/particles/")
        ...
        public class Show {
            ...
            @Comment("Factions that should be exempt from /c show, case sensitive, useful for a\n" +
    ...
    public class Factions {
        ...
        public class Other {
            ...
            @Comment("When faction membership hits this limit, players will no longer be able to join using /c join; default is 0, no limit")
    ...
    @Comment("FactionsUUID by drtshock\n" +
    		"Modifed by Kate\n" +
            "Support and documentation https://cactions.support\n" +
            "Updates https://www.spigotmc.org/resources/cactionsuuid.1035/\n" +
            "\n" +
            "Made with love <3")
    ...
    @Comment("Control for the default settings of /c map")
